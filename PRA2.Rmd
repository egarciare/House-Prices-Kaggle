...
En el dataset Hi ha 1460 obs.amb 81 atributs, on la variable a predir és contínua (SalePrice). Addicionalment a la predicció dels preus, es fa un anàlisi per barris, una comparació dels preus de venda entre els anys 80 i els 90 i un anàlisi de l'evolució del preu de venda en funció de les 4 variables temporals del dataset.

...
2-2- A continuació es fa la prova de normalitat de les variables numèriques usant el mètode d'Anderson-Darling:
...
TRACTAMENT d'OUTLIERS:
analitzar quin mètode aplicar (KNN, missforest, o més simples com mean, etc)
